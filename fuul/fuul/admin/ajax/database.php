...
class Database{
		...
		private $db_name = "inventory";   // Change as required
		...
		function alert_success($message) # success alert only
		{
			$alert =  '<div class="alert alert-success alert-dismissible" id="alert" role="alert">'
				. '<i class="fas fa-check-circle"></i> '
				. '<button type="button" class="close" data-dismiss="alert" aria-label="Close">'
				. '<span aria-hidden="true">&times;</span></button> ' . $message
				. '<div class="progress"  style="height: 2px;">
				<div class="progress-bar bg-success" id="progress_bar" role="progressbar" style="width: 0%;" ></div>
				</div></div>';
			return $alert;
		}
	...
	public function alert($type,$message)
			...
			public function pro($table,$params=array()){
   
            
				// $table_colums = implode("', '", array_keys($params));
			$table_value = implode("', '", $params);
			  $sql = "call $table ('$table_value','insert')";
